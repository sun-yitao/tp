...
:exclamation: You must delete TAsker’s storage file located at `/data/tasker.json` before running it! Not doing so will cause TAsker to default to an empty address book!
