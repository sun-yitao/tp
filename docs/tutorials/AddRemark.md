...
:exclamation: You must delete TAsker’s storage file located at `/data/addressbook.json` before running it! Not doing so will cause TAsker to default to an empty address book!
